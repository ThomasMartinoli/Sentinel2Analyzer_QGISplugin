...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'sentinel2analyzer_dialog_base.ui'))


class sentinel2analyzerDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(sentinel2analyzerDialog, self).__init__(parent)
